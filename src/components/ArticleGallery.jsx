...
export function ArticleGallery() {
    ...
    let imgSet = "group relative flex h-48 items-end overflow-hidden rounded-sm  shadow-lg md:col-span-2 md:h-80"
    let anim = "absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110"
    let text = "relative ml-4 mb-3 inline-block text-sm text-white md:ml-5 md:text-lg"
